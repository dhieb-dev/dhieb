...
export function Themes() {
  ...
  return (
    <button onClick={handleClick} className="themes w-8 dark:fill-zinc-200">
      {theme === "dark" ? themesIcon.moon : theme === "light" ? themesIcon.sun : themesIcon.system}
    </button>
  );
};